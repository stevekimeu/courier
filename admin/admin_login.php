...
<table id="Outer" bgcolor="#228B22" border="0" cellpadding="0" cellspacing="0" align="center" width="780">
  <tbody><tr>
...
<tbody><tr>
<td colspan="15"><img src="../images/mulling_logo.jpg" height="100" width="900"></td>
</tr>
                        ...
                        <form name="form1" id="form1" method="post" onSubmit="return memloginvalidate()">
                          <td><table bgcolor="#FFFFFF" border="0" cellpadding="3" cellspacing="1" width="100%">
                              ...
                              <tr>
								...
								<div class="headtext13" align="center"><strong>System Administrator Login </strong></div></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><input name="Submit" class="green-button" value="Sign in" type="submit" style="padding:5px 10px;font-weight:bold;" ></td>
                              </tr>
                          </tbody>
						  </table>
						  </form>
