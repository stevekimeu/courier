...
<html>
	...
	<?php include("master.php");
		...
		$sql = mysqli_query($dbConn,"SELECT * FROM tbl_messages WHERE id ='$id'"); // select query
...
<table>	
	...
	<tr><td>
		  <div class="form-group">
					...
					<input type="TEXT" name="receiver"  class = "form-control1" readonly value="<?php echo $data['sender'];?>" />
		</div>
		</td></tr>
	<tr><td>
			<div class="form-group">
