...
<table border="0" align="center" width="80%">
    ...
    <tr>
      <td class="LargeBlue" bgcolor="#FFFFFF" align="left"><div class="Partext1" align="center"><strong>All system Users </strong></div></td>
    </tr>
  </tbody></table>
  ...
  <table class="blackbox" border="0" cellpadding="1" cellspacing="1" align="center" width="95%">
    <tbody><tr class="BoldRED" bgcolor="#FFFFFF" style="height:20px;">
      <td class="newtext" bgcolor="#EDEDED" width="20%">User Name </td>
      ...
      <td class="newtext" bgcolor="#EDEDED" width="20%">Alternative Contact Number</td>
      <td class="newtext" bgcolor="#EDEDED" width="15%">User Category</td>
    </tr>
	<?php
